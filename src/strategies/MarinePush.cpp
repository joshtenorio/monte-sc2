...
void MarinePush::initialize(){
    ...
    pushPriorityStep(sc2::ABILITY_ID::BUILD_ENGINEERINGBAY, STEP_BLOCKING);
    pushPriorityStep(sc2::ABILITY_ID::RESEARCH_TERRANINFANTRYWEAPONSLEVEL1, STEP_NONBLOCKING);
