...
class BuildingPlacer {
    ...
    sc2::Unit* findUnit(sc2::ABILITY_ID building, const sc2::Point3D* near);

    protected:
    sc2::Point2D findBarracksLocation();        // will place barracks at the main ramp if no barracks exist
    sc2::Unit* findRefineryLocation(Expansion* e);
    ...
    sc2::Unit* findUnitForAddon(sc2::ABILITY_ID building, sc2::Point2D* near);
